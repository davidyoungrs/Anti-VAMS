...
export default function InspectionFormBallValve({ valveId, inspectionId, onBack, onSave }) {
    const { role } = useAuth();
    ...
    const componentGroups = VALVE_COMPONENT_CONFIGS['Ball Valve'];

    return (
        <div className="inspection-form">
            <div className="inspection-header">
                <button onClick={onBack} className="back-button">← Back to Inspections</button>
                <h2>{inspectionId ? 'Edit Ball Valve Inspection' : 'New Ball Valve Inspection'}</h2>
            </div>
