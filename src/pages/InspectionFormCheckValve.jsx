...
export default function InspectionFormCheckValve({ valveId, inspectionId, onBack, onSave }) {
    ...
    const componentGroups = VALVE_COMPONENT_CONFIGS['Check Valve'];

    return (
        <div className="inspection-form">
            <div className="inspection-header">
                <button onClick={onBack} className="back-button">← Back to Inspections</button>
                <h2>{inspectionId ? 'Edit Check Valve Inspection' : 'New Check Valve Inspection'}</h2>
            </div>
