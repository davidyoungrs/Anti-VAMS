...
export default function InspectionFormGateValve({ valveId, inspectionId, onBack, onSave }) {
    ...
    // Use specific config for Gate Valve
    const componentGroups = VALVE_COMPONENT_CONFIGS['Gate Valve'];

    return (
        <div className="inspection-form">
            <div className="inspection-header">
                <button onClick={onBack} className="back-button">← Back to Inspections</button>
                <h2>{inspectionId ? 'Edit Gate Valve Inspection' : 'New Gate Valve Inspection'}</h2>
            </div>
