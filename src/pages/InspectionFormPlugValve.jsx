...
export default function InspectionFormPlugValve({ valveId, inspectionId, onBack, onSave }) {
    ...
    const componentGroups = VALVE_COMPONENT_CONFIGS['Plug Valve'];

    return (
        <div className="inspection-form">
            <div className="inspection-header">
                <button onClick={onBack} className="back-button">← Back to Inspections</button>
                <h2>{inspectionId ? 'Edit Plug Valve Inspection' : 'New Plug Valve Inspection'}</h2>
            </div>
