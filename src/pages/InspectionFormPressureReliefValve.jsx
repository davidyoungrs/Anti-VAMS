...
export default function InspectionFormPressureReliefValve({ valveId, inspectionId, onBack, onSave }) {
    ...
    const componentGroups = VALVE_COMPONENT_CONFIGS['Pressure Relief Valve'];

    return (
        <div className="inspection-form">
            <div className="inspection-header">
                <button onClick={onBack} className="back-button">← Back to Inspections</button>
                <h2>{inspectionId ? 'Edit PRV Inspection' : 'New PRV Inspection'}</h2>
            </div>
